...
export const ALL_MODELS = [
  ...
  { id:"hy4", name:"【NB】hy4", desc:"腾讯混元HY4，深度推理", type:"chat", supportsReasoning:true, supportsImages:true, supportsToolCall:false, maxInputTokens:128000, maxOutputTokens:8192, defaultReasoning:"high" , supportedEfforts:["low","medium","high","xhigh","max"], defaultEffort:"medium", canDisableThinking:true },
  ...
  { id:"glm-5.3-flash", name:"【NB】glm-5.3-flash", desc:"智谱快速版，低延迟高性价比", type:"chat", supportsReasoning:true, supportsImages:true, supportsToolCall:true, maxInputTokens:1000000, maxOutputTokens:128000, defaultReasoning:"medium" , supportedEfforts:["low","medium","high","xhigh","max"], defaultEffort:"medium", canDisableThinking:true },
