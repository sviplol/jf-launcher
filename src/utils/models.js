...
export const ALL_MODELS = [
  ...
  { id:"glm-5.1", name:"【NB】glm-5.1", desc:"智谱上一代旗舰", type:"chat", supportsReasoning:true, supportsImages:true, supportsToolCall:true, maxInputTokens:1000000, maxOutputTokens:128000, defaultReasoning:"high" , supportedEfforts:["low","medium","high","xhigh","max"], defaultEffort:"medium", canDisableThinking:true },
  ...
  { id:"minimax-m3", name:"【NB】minimax-m3", desc:"MiniMax 最新版", type:"chat", supportsReasoning:false, supportsImages:true, supportsToolCall:true, maxInputTokens:128000, maxOutputTokens:8192, defaultReasoning:"none" },
  ...
  { id:"kimi-k2.6", name:"【NB】kimi-k2.6", desc:"Kimi 上一版本", type:"chat", supportsReasoning:true, supportsImages:true, supportsToolCall:true, maxInputTokens:128000, maxOutputTokens:8192, defaultReasoning:"medium" , supportedEfforts:["low","medium","high","xhigh","max"], defaultEffort:"medium", canDisableThinking:true },
  ...
  { id:"deepseek-v4-flash", name:"【NB】deepseek-v4-flash", desc:"快速版，低延迟", type:"chat", supportsReasoning:false, supportsImages:true, supportsToolCall:true, maxInputTokens:128000, maxOutputTokens:8192, defaultReasoning:"none" },
  { id:"deepseek-v4-pro", name:"【NB】deepseek-v4-pro", desc:"DeepSeek 专业版", type:"chat", supportsReasoning:true, supportsImages:true, supportsToolCall:true, maxInputTokens:1000000, maxOutputTokens:128000, defaultReasoning:"medium" , supportedEfforts:["low","medium","high","xhigh","max"], defaultEffort:"medium", canDisableThinking:true },
